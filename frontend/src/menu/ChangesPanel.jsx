...
export default function ChangesPanel({ onClose }) {
  ...
  const entries = [
    { version: t('changelog.title'), title: t('changelog.titleName'), changes: [
      ...
      t('changelog.changes16'), t('changelog.changes17'),
    ] },
    { version: t('changelog.v0103'), title: t('changelog.v0103Name'), changes: [
      ...
      t('changelog.v010316'), t('changelog.v010317'), t('changelog.v010318'),
      t('changelog.v010319'), t('changelog.v010320'), t('changelog.v010321'), t('changelog.v010322'),
      t('changelog.v010323'), t('changelog.v010324'), t('changelog.v010325'), t('changelog.v010326'),
      t('changelog.v010327'), t('changelog.v010328'), t('changelog.v010329'),
    ] },
