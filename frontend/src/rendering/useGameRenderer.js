...
import { advanceShieldBreakFx } from './draw/shieldHalo';
...
export default function useGameRenderer({
  ...
  useEffect(() => {
    ...
    const render = () => {
      ...
      drawPlayers(ctx, { entitiesRef, visionRef, assetImages, playerAnimRef, myPlayerId, shieldFxRef: shieldHaloRef });
      ...
      advanceShieldBreakFx(ctx, shieldHaloRef);
