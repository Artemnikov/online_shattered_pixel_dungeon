...
export default function WndTrinketChoice({ kinds, onChoose, onClose }) {
  ...
  return (
    <WndOverlay id="wnd-trinket-choice" level={WindowLevel.SECONDARY} onClose={onClose} className="choice-modal-backdrop">
      <div className="choice-modal alchemy-trinket-choice" onClick={(e) => e.stopPropagation()}>
